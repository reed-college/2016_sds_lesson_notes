...
Your Computer  
Hey Server! Gimme thewebpage.com!
...
``` example
HTTP/1.1 200 OK
Date: Mon, 04 Apr 2016 03:51:25 GMT
Expires: -1
...
Date: Mon, 04 Apr 2016 03:51:28 GMT
...
X-XSS-Protection: 1; mode=block
X-Frame-Options: SAMEORIGIN
Set-Cookie: NID=78=Iq75DrYCnBpZxOG6VvzsyuFkshC9XgSS6-6JKrGkjnWCjBIw0x36FF9BYdGWxVzIlV9yiQ3eoE7R9qNR0f0MfKbwWQWUABWqJ-8yP0Hc4S4zIFty-0fz8tkPY_eEI2l85V-0hU2LH5s_EQ; expires=Tue, 04-Oct-2016 03:51:28 GMT; path=/; domain=.google.com; HttpOnly
Transfer-Encoding: chunked
Accept-Ranges: none
Vary: Accept-Encoding
```
...
&lt;REQUEST&gt; Your Computer  
Hey thewebpage.com! I'd like to `GET` the root resource at `/`, please!

&lt;RESPONSE&gt; The Server  
200 OK you got it! Here's a `text/html` response body for my root `index.html`. Also can you hang on to this cookie for me? Send it back to me next time so I can keep track of you a little.
...
You, the User  
Computer, bring me www.google.com

Computer  
Great. Do I know the IP address of a DNS server? **checks** Yes, I do. Hey DNS Server! What the hell is www.google.com?

DNS Server  
I'm not sure, but I know a DNS Server who does. Talk to Google's DNS Server – have an IP address.

Computer  
Hokay. Hey Google's DNS Server. What the hell is www.google.com?

Google's DNS Server  
Oh, it's this – have an IP Addres.
...
You, the User  
Computer, bring me thewebpage.com

Computer  
Great. Do I know the IP address of a DNS server? **checks** Yes, I do. Hey DNS Server! What the hell is thewebpage.com?

DNS Server  
I'm not sure, but I know a DNS Server who does. Talk to the server at this IP Address.

Computer  
Hokay. Hey next DNS Server. What the hell is thewebpage.com?

Next DNS Server  
Oh, it's this – have an IP Addres.

Computer  
Great. Hey thewebpage.com! I'd like to `GET` the root resource at `/`, please!

The Server  
200 OK you got it! Here's a `text/html` response body for my root `index.html`. Also can you hang on to this cookie for me? Send it back to me next time so I can keep track of you a little.

Computer  
Great. Hey the User: here is some rendered HTML.
...
A Web Server  
some flavor of code you've written that responds to HTTP requests with HTTP/JavaScript/images/etc.

A Client  
Probably almost entirely JavaScript; might talk to a Server, rendering results. Might be the entire deal, for sufficiently simple apps.
